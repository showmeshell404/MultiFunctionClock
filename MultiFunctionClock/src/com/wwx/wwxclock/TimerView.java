...
public class TimerView extends LinearLayout {
	...
	private void startTimer() {
		if (timerTask == null) {
			allTimerCount = Integer.parseInt(etHour.getText().toString()) * 60 * 60
					+ Integer.parseInt(etMin.getText().toString()) * 60 + Integer.parseInt(etSec.getText().toString());
	...
	private Button btnStart, btnPause, btnKeep, btnReset;
